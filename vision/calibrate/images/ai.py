...
# so, if you notice our robot not behaving very well, i would comment this block
#of code out and uncomment the goToBall() call right about this
#from here
...
def goToBall(rx, ry, rw, bx, by):              
    ...
    motion(rx, ry, rw, bx, by, rw, time)       

def attackGoal(rx, ry, rw):                    
    time = determineTime(rx, ry, 100, 0)       
    motion(rx, ry, rw, 100, 0, time)           
